...
if __name__ == "__main__":
    ...
    Applets_login_url = AC.get_AuthenticationURL(config.get('imi_base_url_ch', 'base_url_dev_k8s'),
    ...
    commonURL = common.get_commonURL(config.get('imi_base_url_ch', 'base_url_dev_k8s'),
    ...
    if result_common["stateCode"] == 200:
        ...
        if error_failure_number < 4:
            exe_result = 2
            mysql.insertInto_autoTest_record(area, system_type, business_type, task_name, start_time, end_time,
                                             exe_result,
