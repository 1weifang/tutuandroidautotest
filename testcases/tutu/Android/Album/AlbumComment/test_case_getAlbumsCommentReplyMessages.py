#!/usr/bin/python3
# -*- coding: utf-8 -*-
# @Time    : 2019/11/21 16:24
# @Author  : Durat
# @Email   : durant.zeng@sunvalley.com.cn
# @File    : test_case_getAlbumsCommentReplyMessages.py
# @Software: PyCharm
...
class TestgetAlbumsCommentReplyMessagesFunc(unittest.TestCase):
    ...
    @unittest.skip("不执行")
    def test_getAlbumsCommentReplyMessages_tutu_Android_001(self):
        '''美甲涂涂移动Android端_个人中心—我的消息查看_正常查询_手机号密码登录_001'''
