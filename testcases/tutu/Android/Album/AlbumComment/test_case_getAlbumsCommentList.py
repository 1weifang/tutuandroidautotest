...
# @File    : test_case_getAlbumsCommentList.py
# @Software: PyCharm
...
class TestgetAlbumsCommentListFunc(unittest.TestCase):
    """Test getAlbumsCommentList.py"""
    ...
    @unittest.skip("不执行")
    def test_getAlbumsCommentList_tutu_Android_001(self):
        '''美甲涂涂移动Android端_专辑评论列表查询_正常查询_手机号密码登录_001'''
        #安卓登录
