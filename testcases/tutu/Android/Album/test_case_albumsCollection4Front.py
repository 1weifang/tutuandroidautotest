#!/usr/bin/python3
# -*- coding: utf-8 -*-
# @Time    : 2019/11/15 14:11
# @Author  : Durat
# @Email   : durant.zeng@sunvalley.com.cn
# @File    : test_case_albumsCollection4Front.py
# @Software: PyCharm
...
class TestalbumsCollection4FrontFunc(unittest.TestCase):
    """Test albumsCollection4Front.py"""
    ...
    def test_albumsCollection4Front_tutu_Android_001(self):
        '''美甲涂涂移动Android端_特辑一键收藏(2.0)_正常一键收藏_手机号密码登录_001'''
        # 登录
