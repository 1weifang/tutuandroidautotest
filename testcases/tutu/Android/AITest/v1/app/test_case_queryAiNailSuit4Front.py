#!/usr/bin/python3
# -*- coding: utf-8 -*-
# @Time    : 2019/11/19 13:39
# @Author  : Durat
# @Email   : durant.zeng@sunvalley.com.cn
# @File    : test_case_queryAiNailSuit4Front.py
# @Software: PyCharm
...
class TestqueryAiNailSuit4FrontFunc(unittest.TestCase):
    """Test queryAiNailSuit4Front.py"""
    ...
    @unittest.skip("test")
    def test_queryAiNailSuit4Front_pad_ch_001(self):
        '''美甲涂涂端_Ai试甲-查Ai推荐套图+特辑套图(无)+普通套图_zh_Android_正常查询_手机号密码登录'''
        # 安卓app登录
    ...
    @unittest.skip("调试")
    def test_queryAiNailSuit4Front_pad_ch_002(self):
        '''美甲涂涂端_Ai试甲-查Ai推荐套图+特辑套图(有)+普通套图_zh_Android_正常查询_手机号密码登录'''
        # 安卓app登录
        TestData = self.ex.getDict(2, 25, 7, self.testData)
        currentPage = TestData["currentPage"]
        pageSize = TestData["pageSize"]
