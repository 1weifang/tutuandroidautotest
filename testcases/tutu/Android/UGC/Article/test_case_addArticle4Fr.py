...
# @File    : test_case_addArticle4Fr.py
# @Software: PyCharm
...
class TestaddArticle4FrFunc(unittest.TestCase):
    """Test addArticle4Fr.py"""
    ...
    def test_addArticle4Fr_tutu_Android_001(self):
        '''美甲涂涂移动Android端_addArticle4Fr_UGC发布笔记_图片_001'''
