#!/usr/bin/python3
# -*- coding: utf-8 -*-
# @Time    : 2020/2/28 10:24
# @Author  : Durat
# @Email   : durant.zeng@sunvalley.com.cn
# @File    : test_case_getReplySimpleList4Fr.py
# @Software: PyCharm
...
class TestgetReplySimpleList4FrFunc(unittest.TestCase):
    ...
    def test_getReplySimpleList4Fr_tutu_Android_001(self):
        '''美甲涂涂移动Android端_getReplySimpleList4Fr_回复-查询列表(简单形)_001'''
