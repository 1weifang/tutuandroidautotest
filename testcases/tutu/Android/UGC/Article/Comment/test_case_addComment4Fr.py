#!/usr/bin/python3
# -*- coding: utf-8 -*-
# @Time    : 2020/2/27 16:36
# @Author  : Durat
# @Email   : durant.zeng@sunvalley.com.cn
# @File    : test_case_addComment4Fr.py
# @Software: PyCharm
...
class TestaddComment4FrFunc(unittest.TestCase):
    """Test addComment4Fr.py"""
    ...
    def test_addComment4Fr_tutu_Android_001(self):
        '''美甲涂涂移动Android端_addComment4Fr_UGC评论-发表_001'''
