#!/usr/bin/python3
# -*- coding: utf-8 -*-
# @Time    : 2020/2/27 16:48
# @Author  : Durat
# @Email   : durant.zeng@sunvalley.com.cn
# @File    : test_case_getCommentList4Fr.py
# @Software: PyCharm
...
class TestgetCommentList4FrFunc(unittest.TestCase):
    """Test getCommentList4Fr.py"""
    ...
    def test_getCommentList4Fr_tutu_Android_001(self):
        '''美甲涂涂移动Android端_getCommentList4Fr_UGC评论-查询列表_001'''
