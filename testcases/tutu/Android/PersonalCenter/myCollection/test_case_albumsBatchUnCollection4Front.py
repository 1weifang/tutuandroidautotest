...
# @File    : test_case_albumsBatchUnCollection4Front.py
# @Software: PyCharm
...
class TestalbumsBatchUnCollection4FrontFunc(unittest.TestCase):
    """Test albumsBatchUnCollection4Front.py"""
    ...
    def test_albumsBatchUnCollection4Front_tutu_Android_001(self):
        '''美甲涂涂移动Android端_个人中心-我的收藏(专辑列表)(批量删除特辑)_正常删除_001'''
        # 第一步，获取excel中的测试数据
