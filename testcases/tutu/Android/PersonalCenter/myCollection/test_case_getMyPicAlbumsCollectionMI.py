#!/usr/bin/python3
# -*- coding: utf-8 -*-
# @Time    : 2019/11/15 14:59
# @Author  : Durat
# @Email   : durant.zeng@sunvalley.com.cn
# @File    : test_case_getMyPicAlbumsCollectionMI.py
# @Software: PyCharm
...
class TestgetMyPicAlbumsCollectionMIFunc(unittest.TestCase):
    """Test getMyPicAlbumsCollectionMI.py"""
    ...
    def test_getMyPicAlbumsCollectionMI_tutu_Android_001(self):
        '''美甲涂涂移动Android端_个人中心-我的收藏(专辑列表)_正常查询_001'''
        # 登录
        ...
        #我的收藏（专辑列表）
        getMyAlbumsURL = self.getMyAlbums.get_getMyPicAlbumsCollectionMIURL(self.config.get('imi_base_url_ch', 'base_url_dev_k8s'),
        ...
        #批量删除特辑
        albumsBatchURL = self.albumsBatch.get_albumsBatchUnCollection4FrontURL(self.config.get('imi_base_url_ch', 'base_url_dev_k8s'),
